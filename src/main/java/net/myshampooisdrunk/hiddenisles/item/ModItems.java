...
public class ModItems {
    //ores
    public static final Item PRIMORDIUM_CLUSTER = registerItem( "primordium_cluster", new Item(new FabricItemSettings()) );
    public static final Item PRISTINIUM_CLUSTER = registerItem( "pristinium_cluster", new Item(new FabricItemSettings()) );
    public static final Item COORDIUM_CLUSTER = registerItem( "coordium_cluster", new Item(new FabricItemSettings()) );
    public static final Item TROCELLATE_CLUSTER = registerItem( "trocellate_cluster", new Item(new FabricItemSettings()) );
    public static final Item DOMDECON_CLUSTER = registerItem( "domdecon_cluster", new Item(new FabricItemSettings()) );
    public static final Item ASCONDELLUM_CLUSTER = registerItem( "ascondellum_cluster", new Item(new FabricItemSettings()) );
    public static final Item ARCONLON_CLUSTER = registerItem( "arconlon_cluster", new Item(new FabricItemSettings()) );

    public static final Item PRIMORDIUM_INGOT = registerItem( "primordium_ingot", new Item(new FabricItemSettings()) );
    public static final Item PRISTINIUM_INGOT = registerItem( "pristinium_ingot", new Item(new FabricItemSettings()) );
    public static final Item COORDIUM_INGOT = registerItem( "coordoium_ingot", new Item(new FabricItemSettings()) );
    public static final Item TROCELLATE_INGOT = registerItem( "trocellate_ingot", new Item(new FabricItemSettings()) );
    public static final Item DOMDECON_INGOT = registerItem( "domdecon_ingot", new Item(new FabricItemSettings()) );
    public static final Item ASCONDELLUM_INGOT = registerItem( "ascondellum_ingot", new Item(new FabricItemSettings()) );
    public static final Item ARCONLON_INGOT = registerItem( "arconlon_ingot", new Item(new FabricItemSettings()) );


    //tools/weapons
    public static final Item PRIMORDIUM_BLADE = registerItem("primordium_sword",
            new ModSwordItem(ModToolMaterials.PRIMORDIUM , 13, -2.4f , new FabricItemSettings()));//base attack speed is 4 so negative numbers are needed for desirable outcome

    public static final Item PRISTINIUM_BLADE = registerItem("pristinium_sword",
            new ModSwordItem(ModToolMaterials.PRISTINIUM , 13, -2.4f , new FabricItemSettings()));

    public static final Item COORDIUM_BLADE = registerItem("coordium_sword",
            new ModSwordItem(ModToolMaterials.COORDIUM , 14, -2.4f , new FabricItemSettings()));

    public static final Item TROCELLATE_BLADE = registerItem("trocellate_sword",
            new ModSwordItem(ModToolMaterials.TROCELLATE , 13, -2.4f , new FabricItemSettings()));

    public static final Item DOMDECON_BLADE = registerItem("domdecon_sword",
            new ModSwordItem(ModToolMaterials.DOMDECON , 13, -2.4f , new FabricItemSettings()));

    public static final Item ASCONDELLUM_BLADE = registerItem("ascondellum_sword",
            new ModSwordItem(ModToolMaterials.ASCONDELLUM , 13, -2.4f , new FabricItemSettings()));

    public static final Item ARCONLON_BLADE = registerItem("arconlon_sword",
            new ModSwordItem(ModToolMaterials.ARCONLON , 13, -2.4f , new FabricItemSettings()));
    ...
    private static Item registerItem(String name, Item item){
        ItemGroupEvents.modifyEntriesEvent(ModItemGroup.HIDDENISLESTAB).register(entries -> entries.add(item));

        return Registry.register(Registries.ITEM, new Identifier(HiddenIsles.MOD_ID, name), item);
    }

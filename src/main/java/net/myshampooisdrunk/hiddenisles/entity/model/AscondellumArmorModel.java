...
public class AscondellumArmorModel extends AnimatedGeoModel<ModArmorItem> {
    @Override
    ...
    public Identifier getTextureLocation(ModArmorItem object) {
        return new Identifier(HiddenIsles.MOD_ID, "textures/entity/ascondellum_armor.png");
    }

...
public class MissileModel extends Model {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        rocketbottom.addChild("leg4", ModelPartBuilder.create()
                .uv(88, 59).cuboid(-0.5F, 0.0F, 2.5F, 1.0F, 2.0F, 0.0F, new Dilation(0.2F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.4363F, 0.0F, 0.0F));
        rocketbottom.addChild("leg3", ModelPartBuilder.create()
                .uv(90, 49).cuboid(-0.5F, 0.0F, -2.5F, 1.0F, 2.0F, 0.0F, new Dilation(0.2F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -0.4363F, 0.0F, 0.0F));
        rocketbottom.addChild("leg2", ModelPartBuilder.create()
                .uv(110, 26).cuboid(2.5F, 0.0F, -0.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.2F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.4363F));
        rocketbottom.addChild("leg1", ModelPartBuilder.create()
                .uv(80, 35).cuboid(-2.5F, 0.0F, -0.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.2F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.4363F));
        root.addChild("rocketmiddle", ModelPartBuilder.create()
                .uv(3, 14).cuboid(-1.5F, -7.0F, -2.5F, 3.0F, 6.0F, 5.0F, new Dilation(0.0F))
        ...
        ModelPartData rockettop = root.addChild("rockettop", ModelPartBuilder.create()
                .uv(8, 9).cuboid(-2.0F, -14.0F, -1.0F, 4.0F, 3.0F, 2.0F, new Dilation(0.0F))
        ...
        rockettop.addChild("rockettip4", ModelPartBuilder.create()
                .uv(0, 0).cuboid(-0.5F, -15.0F, -1.5F, 1.0F, 1.0F, 3.0F, new Dilation(0.0F))
        ...
        root.addChild("bottomfins", ModelPartBuilder.create()
                .uv(0, 0).cuboid(-4.5F, -3.0F, 0.0F, 9.0F, 2.0F, 0.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(0.0F, -3.0F, -4.0F, 0.0F, 2.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
        root.addChild("middlefins", ModelPartBuilder.create().
                uv(0, 0).cuboid(-4.0F, -8.0F, 0.0F, 8.0F, 2.0F, 0.0F, new Dilation(0.0F))
